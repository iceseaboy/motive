...
extension Animation {
    ...
    static let auroraInstant = Animation.easeOut(duration: 0.1)
    static let auroraFast = Animation.easeOut(duration: 0.15)
    static let auroraNormal = Animation.easeInOut(duration: 0.25)
    static let auroraSlow = Animation.easeInOut(duration: 0.4)
